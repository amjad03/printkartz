...
class _CarouselWithIndicatorState extends State<CarouselWithIndicator> {
        ...
        .map((item) => Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                          color: Colors.black38, blurRadius: Dimensions.five)
                    ]),
                child: ClipRRect(
                  borderRadius:
  ...
  Widget build(BuildContext context) {
    ...
    var colorSelected = Theme.of(context).brightness == Brightness.dark
        ? const Color.fromRGBO(255, 255, 255, 0.9)
        : const Color.fromRGBO(0, 0, 0, 0.9);
    var colorUnselected = Theme.of(context).brightness == Brightness.dark
        ...
        children: widget.data.map((url) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              color: _current == index ? colorSelected : colorUnselected,
            ),
          );
        }).toList(),
      ),
